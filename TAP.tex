...
use the minor version (e.g. \verb|version="1.1"|).
...
ADQL \citep{2008ivoa.spec.1030O} but restricted as described in section~\ref{sec:tap-schema}. 
...
\item Clarified required and optional ADQL geometric functions.
...
\begin{itemize}
\item Added arraysize in \tapschema{} to allow the complete VOTable arraysize syntax and specified that the effective datatype in TAP is specified as in VOTable using datatype,arraysize, and xtype (\ref{sec:tap-schema-columns}).

...
content having a \xmlel{property} attribute valued query. It contains the query itself, 
...
reference to these columns in the select clause but not in any other part of the query. 

\textbf{TODO: add a mechanism for services to say a column can only be selected. ADQL xtypes?}
...
\subsection{WD-TAP-1.1-20170704}

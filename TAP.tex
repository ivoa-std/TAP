...
may be used for authenticated access. The VOSI-availabilty and -capabilities resources 
must allow anonymous access as they can be used by clients to determine if the service is available 
...
the service as a whole. TAP 
clients should not depend on a specific representation of the root resource.

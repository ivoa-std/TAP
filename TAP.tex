...
given in the interface defined in the TAP capability. The TAP capabilty normally
...
contain column metadata and that the detail parameter is suppoorted. The securityMethod(s) 
tell clients that authenticating may effect the output such as exposing metadata for 
protected tables.

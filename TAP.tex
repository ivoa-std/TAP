...
\tapschema.key\_columns respectively) must refer to column in the \tapschema.columns table. Likewise, 
the target\_table and target\_column must also refer to a column in \tapschema.columns.

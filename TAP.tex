...
requirement to that effect, the response on a TAP service's capabilities
endpoint should contain instances of \xmlel{uws:Async}-typed and
...
child resources have specific names (section~\ref{sec:resources}). One or more DALI-async 
...
providers to describe multiple resources (interfaces) that 
deliver the query features (e.g. with different protocols or authentication methods) in 
